...
# Output Messages
MSG_INFO_MESSAGE                := ' ['$(FMT_CMDHL_BEGIN)'INFO'$(FMT_ANSIC_END)']    :'
MSG_COMPILE_CMD                 := ' ['$(FMT_CMDHL_BEGIN)'GCC'$(FMT_ANSIC_END)']     :'
MSG_ASSEMBLE_CMD                := ' ['$(FMT_CMDHL_BEGIN)'GAS'$(FMT_ANSIC_END)']     :'
MSG_NM_CMD                      := ' ['$(FMT_CMDHL_BEGIN)'NM'$(FMT_ANSIC_END)']      :'
MSG_REMOVE_CMD                  := ' ['$(FMT_CMDHL_BEGIN)'RM'$(FMT_ANSIC_END)']      :'
MSG_LINK_CMD                    := ' ['$(FMT_CMDHL_BEGIN)'LNK'$(FMT_ANSIC_END)']     :'
MSG_ARCHIVE_CMD                 := ' ['$(FMT_CMDHL_BEGIN)'AR'$(FMT_ANSIC_END)']      :'
MSG_SIZE_CMD                    := ' ['$(FMT_CMDHL_BEGIN)'SIZE'$(FMT_ANSIC_END)']    :'
MSG_OBJCPY_CMD                  := ' ['$(FMT_CMDHL_BEGIN)'OBJCPY'$(FMT_ANSIC_END)']  :'
MSG_OBJDMP_CMD                  := ' ['$(FMT_CMDHL_BEGIN)'OBJDMP'$(FMT_ANSIC_END)']  :'
