...
//        [CardType_NXP_MIFARE_Ultralight_EV1]    = { .ATQA=0x0044, .ATQARelevant=true, .SAK=0x00, .SAKRelevant=false, .ATSRelevant=false, .Manufacturer="NXP", .Type="MIFARE Ultralight EV1" },
    // for the following two, setting ATQARelevant to true would cause checking the ATQA value, but the NXP paper for distinguishing cards does not recommend this
    [CardType_NXP_MIFARE_DESFire]           = { .ATQA = 0x0344, .ATQARelevant = false, .SAK = 0x20, .SAKRelevant = true, .ATSRelevant = true, .ATSSize = 5, .ATS = {0x75, 0x77, 0x81, 0x02, 0x80}, .Manufacturer = "NXP", .Type = "MIFARE DESFire" },
    [CardType_NXP_MIFARE_DESFire_EV1]       = { .ATQA = 0x0344, .ATQARelevant = false, .SAK = 0x20, .SAKRelevant = true, .ATSRelevant = true, .ATSSize = 5, .ATS = {0x75, 0x77, 0x81, 0x02, 0x80}, .Manufacturer = "NXP", .Type = "MIFARE DESFire EV1" },
